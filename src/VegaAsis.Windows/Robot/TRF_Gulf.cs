...
{
    public class TRF_Gulf : TRF_Base
    {
        public override string CompanyId => "gulf";
        public override string CompanyName => "Gulf Sigorta";
        public override string LoginUrl => "https://acenteportal.gulfsigorta.com.tr";
