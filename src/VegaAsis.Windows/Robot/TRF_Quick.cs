...
{
    public class TRF_Quick : TRF_Base
    {
        public override string CompanyId => "quick";
        public override string CompanyName => "Quick Sigorta";
        public override string LoginUrl => "https://acenteportal.quicksigorta.com.tr";
