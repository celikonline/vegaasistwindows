...
{
    public class TRF_Koru : TRF_Base
    {
        public override string CompanyId => "koru";
        public override string CompanyName => "Koru Sigorta";
        public override string LoginUrl => "https://acenteportal.korusigorta.com.tr";
