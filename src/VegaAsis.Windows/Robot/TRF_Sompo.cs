...
{
    public class TRF_Sompo : TRF_Base
    {
        public override string CompanyId => "sompo";
        public override string CompanyName => "Sompo Japan Sigorta";
        public override string LoginUrl => "https://acenteportal.sompo.com.tr";
