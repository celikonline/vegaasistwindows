...
{
    public class TRF_Groupama : TRF_Base
    {
        public override string CompanyId => "groupama";
        public override string CompanyName => "Groupama Sigorta";
        public override string LoginUrl => "https://acenteportal.groupama.com.tr";
