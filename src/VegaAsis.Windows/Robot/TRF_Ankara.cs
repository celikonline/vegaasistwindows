...
{
    public class TRF_Ankara : TRF_Base
    {
        public override string CompanyId => "ankara";
        public override string CompanyName => "Ankara Sigorta";
        public override string LoginUrl => "https://acenteportal.ankarasigorta.com.tr";
