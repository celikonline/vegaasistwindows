...
{
    public class TRF_TurkNippon : TRF_Base
    {
        public override string CompanyId => "turknippon";
        public override string CompanyName => "Türk Nippon Sigorta";
        public override string LoginUrl => "https://acenteportal.turknippon.com.tr";
