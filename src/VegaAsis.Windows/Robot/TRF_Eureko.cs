...
{
    public class TRF_Eureko : TRF_Base
    {
        public override string CompanyId => "eureko";
        public override string CompanyName => "Eureko Sigorta";
        public override string LoginUrl => "https://acenteportal.eureko.com.tr";
