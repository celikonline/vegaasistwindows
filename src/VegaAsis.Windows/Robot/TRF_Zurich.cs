...
{
    public class TRF_Zurich : TRF_Base
    {
        public override string CompanyId => "zurich";
        public override string CompanyName => "Zurich Sigorta";
        public override string LoginUrl => "https://acenteportal.zurich.com.tr";
