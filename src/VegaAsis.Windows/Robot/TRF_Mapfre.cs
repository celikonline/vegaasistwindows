...
{
    public class TRF_Mapfre : TRF_Base
    {
        public override string CompanyId => "mapfre";
        public override string CompanyName => "Mapfre Sigorta";
        public override string LoginUrl => "https://acenteportal.mapfre.com.tr";
