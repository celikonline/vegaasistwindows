...
{
    public class TRF_Seker : TRF_Base
    {
        public override string CompanyId => "seker";
        public override string CompanyName => "Şeker Sigorta";
        public override string LoginUrl => "https://acenteportal.sekersigorta.com.tr";
