...
{
    public class TRF_Gunes : TRF_Base
    {
        public override string CompanyId => "gunes";
        public override string CompanyName => "Güneş Sigorta";
        public override string LoginUrl => "https://acenteportal.gunessigorta.com.tr";
