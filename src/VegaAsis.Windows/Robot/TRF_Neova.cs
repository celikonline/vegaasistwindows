...
{
    public class TRF_Neova : TRF_Base
    {
        public override string CompanyId => "neova";
        public override string CompanyName => "Neova Sigorta";
        public override string LoginUrl => "https://acenteportal.neova.com.tr";
