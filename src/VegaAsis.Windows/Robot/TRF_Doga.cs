...
{
    public class TRF_Doga : TRF_Base
    {
        public override string CompanyId => "doga";
        public override string CompanyName => "Doğa Sigorta";
        public override string LoginUrl => "https://acenteportal.dogasigorta.com.tr";
