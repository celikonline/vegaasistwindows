...
{
    public class TRF_DemirHayat : TRF_Base
    {
        public override string CompanyId => "demirhayat";
        public override string CompanyName => "Demir Hayat Sigorta";
        public override string LoginUrl => "https://acenteportal.demirhayat.com.tr";
