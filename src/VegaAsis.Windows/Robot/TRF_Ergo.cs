...
{
    public class TRF_Ergo : TRF_Base
    {
        public override string CompanyId => "ergo";
        public override string CompanyName => "Ergo Sigorta";
        public override string LoginUrl => "https://acenteportal.ergo.com.tr";
