...
{
    public class TRF_Unico : TRF_Base
    {
        public override string CompanyId => "unico";
        public override string CompanyName => "Unico Sigorta";
        public override string LoginUrl => "https://acenteportal.unicosigorta.com.tr";
