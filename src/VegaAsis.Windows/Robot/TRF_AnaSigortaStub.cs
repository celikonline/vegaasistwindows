...
{
    /// <summary>
    /// ANA Sigorta şirket robotu – geçici (Stub). Selector ve URL'ler gerçek portala göre güncellenecek; birebir dönüşüm sonrası TRF_AnaSigorta olarak yeniden adlandırılabilir.
    /// </summary>
    public class TRF_AnaSigortaStub : ICompanyRobot
    {
        public string CompanyId => "ana";
        public string CompanyName => "ANA Sigorta";
        public string LoginUrl => "https://www.anasigorta.com.tr";
        ...
        public async Task<string> GetOfferAsync(IBrowserDriver driver, object offerParams)
        {
            ...
            try
            {
                var offerUrl = "https://www.anasigorta.com.tr/teklif"; // placeholder
