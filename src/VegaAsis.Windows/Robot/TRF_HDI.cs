...
{
    public class TRF_HDI : TRF_Base
    {
        public override string CompanyId => "hdi";
        public override string CompanyName => "HDI Sigorta";
        public override string LoginUrl => "https://acenteportal.hdi.com.tr";
