...
{
    public class PoliceNoGitForm : Form
    {
        ...
        private void BtnGit_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Lütfen poliçe numarası girin.", "Uyarı", MessageBoxButtons.OK, MessageBoxIcon.Warning);
