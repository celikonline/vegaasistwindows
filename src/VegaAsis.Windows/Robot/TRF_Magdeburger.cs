...
{
    public class TRF_Magdeburger : TRF_Base
    {
        public override string CompanyId => "magdeburger";
        public override string CompanyName => "Magdeburger Sigorta";
        public override string LoginUrl => "https://acenteportal.magdeburger.com.tr";
