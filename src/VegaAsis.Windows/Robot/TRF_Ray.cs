...
{
    public class TRF_Ray : TRF_Base
    {
        public override string CompanyId => "ray";
        public override string CompanyName => "Ray Sigorta";
        public override string LoginUrl => "https://acenteportal.raysigorta.com.tr";
