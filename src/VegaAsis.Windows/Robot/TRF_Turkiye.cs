...
{
    public class TRF_Turkiye : TRF_Base
    {
        public override string CompanyId => "turkiye";
        public override string CompanyName => "Türkiye Sigorta";
        public override string LoginUrl => "https://acenteportal.turkiyesigorta.com.tr";
