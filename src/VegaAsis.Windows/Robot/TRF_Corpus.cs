...
{
    public class TRF_Corpus : TRF_Base
    {
        public override string CompanyId => "corpus";
        public override string CompanyName => "Corpus Sigorta";
        public override string LoginUrl => "https://acenteportal.corpussigorta.com.tr";
