...
{
    /// <summary>
    /// ANA Sigorta şirket robotu.
    /// Portal URL ve selector'lar gerçek acente portaline göre güncellenmeli (TRF-Selector-Guncelleme.md).
    /// </summary>
    public class TRF_AnaSigorta : TRF_Base
    {
        public override string CompanyId => "ana";
        public override string CompanyName => "ANA Sigorta";
        public override string LoginUrl => "https://www.anasigorta.com.tr";
        ...
        public override async Task<string> GetOfferAsync(IBrowserDriver driver, object offerParams)
        {
            ...
            try
            {
                driver.Navigate(LoginUrl + "/teklif");
                await Task.Delay(2500).ConfigureAwait(false);
