...
{
    public class TRF_Halk : TRF_Base
    {
        public override string CompanyId => "halk";
        public override string CompanyName => "Halk Sigorta";
        public override string LoginUrl => "https://acenteportal.halksigorta.com.tr";
