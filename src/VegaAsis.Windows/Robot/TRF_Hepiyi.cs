...
{
    public class TRF_Hepiyi : TRF_Base
    {
        public override string CompanyId => "hepiyi";
        public override string CompanyName => "Hepiyi Sigorta";
        public override string LoginUrl => "https://acenteportal.hepiyisigorta.com.tr";
