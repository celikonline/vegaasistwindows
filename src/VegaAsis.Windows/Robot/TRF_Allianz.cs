...
{
    public class TRF_Allianz : TRF_Base
    {
        public override string CompanyId => "allianz";
        public override string CompanyName => "Allianz Sigorta";
        public override string LoginUrl => "https://acenteportal.allianz.com.tr";
