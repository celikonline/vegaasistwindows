...
{
    public class TRF_Bereket : TRF_Base
    {
        public override string CompanyId => "bereket";
        public override string CompanyName => "Bereket Sigorta";
        public override string LoginUrl => "https://acenteportal.bereketsigorta.com.tr";
