...
{
    public class TRF_Generali : TRF_Base
    {
        public override string CompanyId => "generali";
        public override string CompanyName => "Generali Sigorta";
        public override string LoginUrl => "https://acenteportal.generali.com.tr";
